...
public class Maze : MonoBehaviour
{
    ...
    [SerializeField]
    private bool toggle_visualization = false;
    ...
    private void Awake()
    {
        rows = Mathf.FloorToInt(GameObject.FindGameObjectWithTag("Ground").transform.localScale.x / (2*cell_size));
        columns = Mathf.FloorToInt(GameObject.FindGameObjectWithTag("Ground").transform.localScale.z / (2*cell_size));

        grid_size_x = Mathf.FloorToInt(GameObject.FindGameObjectWithTag("Ground").transform.localScale.x / 2);
        grid_size_y = Mathf.FloorToInt(GameObject.FindGameObjectWithTag("Ground").transform.localScale.z / 2);
        g_manager = GameObject.FindGameObjectWithTag("Maze")as GameObject;
